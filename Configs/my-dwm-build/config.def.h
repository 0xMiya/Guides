...
static const char col_gray[]        = "#1e2330"; 
...
static const char *i3lock[]   = { "i3lock", "-i", "/home/vampire/Pictures/open-sourcerer-3440×1440.png", "-e", "-f", NULL };
...
static const char *scrot[]    = { "scrot", "/home/vampire/Pictures/Scrot/S_%d_%m_%Y_%H:%M:%S", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_u,      setlayout,      {.v = &layouts[1]} }, /* floating */
